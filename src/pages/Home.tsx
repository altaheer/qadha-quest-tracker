    ...
    <div className="container max-w-lg mx-auto px-4 py-6">
      ...
      <div className="text-center mb-8 animate-fade-in">
        ...
        <p className="text-muted-foreground">
          Välkommen tillbaka! Här är din dagliga översikt.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <Link
          to="/prayers"
          className="flex items-center justify-between p-4 rounded-2xl gradient-card shadow-card border border-border/50 hover:shadow-elevated transition-all group"
        >
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {qadhaPrayers > 0
                  ? `${qadhaPrayers} böner kvar • ${calculateDaysToComplete()} dagar`
                  : 'Inga missade böner'}
              </p>
            </div>
          </div>
