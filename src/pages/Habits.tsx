...
const iconMap: Record<string, typeof Sun> = { Sun, Moon: MoonIcon, Bed, Utensils };
    ...
    <div className="container max-w-lg mx-auto px-4 py-6">
      ...
      <div className="space-y-4 mb-6">
        {habitCategories.map((category) => {
          ...
          return (
            <div key={category.id} className="rounded-2xl gradient-card shadow-card border border-border/50 overflow-hidden">
                ...
                {pausedHabitsInCategory.length > 0 && (
                  <div className="mt-2 pt-2 border-t border-border/30">
                    ...
                    {pausedHabitsInCategory.map((habit) => (
                      <div key={habit.id} className="flex items-center gap-2 p-3 rounded-xl opacity-50">
