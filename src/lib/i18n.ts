...
const en: Translations = {
  ...
  home: { subtitle: 'A new day, a new page', today: 'Today', rightNow: 'Right now', dayComplete: 'The day is complete — may Allah accept it', moreItems: '+{n} more', sunnahLabel: 'Sunnah', last5days: 'Next 5 days', summary: 'Summary', remaining: 'remaining', active: 'active' },
...
const sv: Translations = {
  ...
  home: { subtitle: 'En ny dag, ett nytt blad', today: 'Idag', rightNow: 'Just nu', dayComplete: 'Dagen är klar — må Allah acceptera den', moreItems: '+{n} mer', sunnahLabel: 'Sunnah', last5days: 'Nästa 5 dagar', summary: 'Sammanfattning', remaining: 'kvar', active: 'aktiva' },
...
const tr: Translations = {
  ...
  home: { subtitle: 'Yeni bir gün, yeni bir sayfa', today: 'Bugün', rightNow: 'Şu anda', dayComplete: 'Gün tamamlandı — Allah kabul etsin', moreItems: '+{n} daha', sunnahLabel: 'Sünnet', last5days: 'Sonraki 5 gün', summary: 'Özet', remaining: 'kaldı', active: 'aktif' },
...
const ar: Translations = {
  ...
  home: { subtitle: 'يوم جديد، صفحة جديدة', today: 'اليوم', rightNow: 'الآن', dayComplete: 'اكتمل اليوم — تقبّل الله', moreItems: '+{n} المزيد', sunnahLabel: 'سنن', last5days: 'الأيام الـ5 القادمة', summary: 'ملخّص', remaining: 'متبقي', active: 'نشطة' },
