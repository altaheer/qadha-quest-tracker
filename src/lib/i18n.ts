...
export type Translations = {
  ...
  settings: { title: string; subtitle: string; language: string; notifications: string; backup: string; restore: string; darkMode: string; dataMgmt: string; dataMgmtDesc: string; dataInfo: string; dataInfoDesc: string; export: string; import: string; resetOnboarding: string; resetOnboardingDone: string };
...
const tr: Translations = {
  ...
  settings: { title: 'Ayarlar', subtitle: 'Uygulamanı ve verini yönet', language: 'Dil', notifications: 'Bildirimler', backup: 'Yedekle', restore: 'Geri yükle', darkMode: 'Koyu mod', dataMgmt: 'Veri yönetimi', dataMgmtDesc: 'Verini dışa ve içe aktar', dataInfo: 'Verin', dataInfoDesc: 'Veri depolama hakkında bilgi', export: 'Veriyi dışa aktar', import: 'Veriyi içe aktar', resetOnboarding: 'Tanıtımı sıfırla', resetOnboardingDone: 'Tanıtım sıfırlandı – uygulamayı yeniden yükle' },
